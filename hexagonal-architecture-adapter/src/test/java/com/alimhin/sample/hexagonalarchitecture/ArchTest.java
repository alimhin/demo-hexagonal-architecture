...
public class ArchTest {
    ...
    private final static String DOMAIN_PACKAGE = "com.alimhin.sample.hexagonalarchitecture.com.alimhin.sample.hexagonalarchitecture.domain..";
    ...
    void domainAndApplicationShouldNotDependsOnInfrastructureLayer(){
        ...
        noClasses()
                ...
                .because("On hexagonal architecture, com.alimhin.sample.hexagonalarchitecture.domain and application should not depends on infrastructure")
    ...
    void domainAndApplicationShouldNotDependsOnAnyExternalFramework() {
        ...
        noClasses()
                ...
                .because("On hexagonal architecture, com.alimhin.sample.hexagonalarchitecture.domain and application should not depends on spring framework")
                .check(importedClasses);
    }
}
