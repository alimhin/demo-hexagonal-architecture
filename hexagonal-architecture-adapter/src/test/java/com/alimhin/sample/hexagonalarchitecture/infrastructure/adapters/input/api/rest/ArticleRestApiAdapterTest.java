...
import com.alimhin.sample.hexagonalarchitecture.infrastructure.adapters.input.api.util.TestUtil;
...
import com.alimhin.sample.hexagonalarchitecture.infrastructure.adapters.input.api.rest.data.ArticleStatus;
import com.alimhin.sample.hexagonalarchitecture.infrastructure.adapters.input.api.rest.mapper.ApiArticleMapper;
...
@SpringBootTest(classes = {ArticleRestApiAdapter.class})
@AutoConfigureMockMvc
@EnableWebMvc
class ArticleRestApiAdapterTest {
