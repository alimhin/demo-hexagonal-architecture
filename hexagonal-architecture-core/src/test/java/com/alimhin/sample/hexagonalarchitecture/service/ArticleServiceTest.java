...
class ArticleServiceTest {
    ...
    void updateArticle() {
        ...
        when(articleOutput.getById(DEFAULT_ID)).thenReturn(Optional.of(defaultArticle));
        when(articleOutput.save(defaultArticle))
    ...
    void updateArticle_notFound() {
        // GIVEN
        when(articleOutput.getById(DEFAULT_ID)).thenReturn(Optional.ofNullable(null));
        // WHEN
    ...
    void updateArticle_alreadyPublished() {
        ...
        when(articleOutput.getById(DEFAULT_ID)).thenReturn(Optional.ofNullable(defaultArticle));
        // WHEN
    ...
    void getArticleById() {
        ...
        // THEN
        verify(articleOutput).getById(1L);
    }
