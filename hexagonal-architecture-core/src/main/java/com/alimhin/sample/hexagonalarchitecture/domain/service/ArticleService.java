...
public class ArticleService implements WriteArticle, ReadArticle, ManageArticle {
    ...
    public Article updateArticle(Long id, String title, String body) {
        var article = this.articleOutput.getById(id).orElseThrow(ArticleNotFoundException::new);
    ...
    public Article getArticleById(Long id) {
        return this.articleOutput.getById(id).orElseThrow(ArticleNotFoundException::new);
    }
